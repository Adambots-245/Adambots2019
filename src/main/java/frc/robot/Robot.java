...
public class Robot extends TimedRobot {
    ...
    public void controls() {
        ...
        Drive.drive(Gamepad.primary.getLeftY().get(), Gamepad.primary.getRightX().get(), Gamepad.primary.getA().get(),
                Gamepad.primary.getY().get(), Gamepad.primary.getLB().get(), Gamepad.primary.getRB().get());
        ...
        Elevator.elevator((Gamepad.secondary.getLeftY()), Gamepad.secondary.getTriggers(),
                Gamepad.secondary.getBack().get(), Gamepad.secondary.getLB().get(), Gamepad.secondary.getRB().get());
        ...
        HatchAutomation.hatch(Gamepad.secondary.getY(), Gamepad.secondary.getX(), Gamepad.secondary.getLeftY());
